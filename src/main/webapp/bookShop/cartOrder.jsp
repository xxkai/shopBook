...
<div class="layuimini-main">
    <div class="layui-form layuimini-form">
         <div class="layui-form-item">
            <label class="layui-form-label required">总价格</label>
            <div class="layui-input-block">
            	<input type="hidden" name="arr" value="${arr}">
                <input type="text"  name="total" disabled required lay-verify="required" style="width: 249px;text-align: center;font-size: 20px;color: #ff6700" value="${total}" class="layui-input">
                <tip></tip>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderName" required lay-verify="required|orderName" style="width: 249px;text-align: center;" lay-reqtext="收件人不能为空" placeholder="请输入收件人" value="" class="layui-input">
                <tip>填写收件人姓名。</tip>
            </div>
        </div>
         <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderAddr" required lay-verify="required|orderAddr" style="width: 249px;text-align: center;" lay-reqtext="用户名不能为空" placeholder="请正确书写地址" value="" class="layui-input">
                <tip>填写详细地址。</tip>
            </div>
        </div>
        <div class="layui-form-item" ">
            <div  style="text-align: center;">
                <button style="text-align: center;" class="layui-btn" lay-submit lay-filter="saveBtn">确认支付</button>
            </div>
        </div>
    </div>
</div>
    ...
    layui.use(['form', 'table'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            var index = layer.alert("真的购买吗？", {
            	...
            	$.ajax({
          		  type:'post',
          		  url:'CartAction?method=cartOrder',
          		  data:data.field,
          		  dataType:'json',
