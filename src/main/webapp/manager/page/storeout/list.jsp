    ...
    <div class="layuimini-main">
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container">
                <button class="layui-btn layui-btn-sm data-add-btn"> 出库添加</button>
            </div>
        </script>
...
<script>
    layui.use(['form', 'table','layuimini','element'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: 'StoreoutAction?method=getList',
            toolbar: '#toolbarDemo',
            ...
            cols: [[
               // {type: "checkbox", width: 50, fixed: "left"},
                {field: 'storeoutId',  title: '出库表Id', sort: true},
                {field: 'bookId',  title: '图书Id', sort: true},
                {field: 'userName',  title: '用户名', sort: true},
                {field: 'storeoutNum', title: '添加数量',sort:true},
        ...
        $(".data-add-btn").on("click", function () {
            var content = layuimini.getHrefContent('page/table/storeoutAdd.jsp');
         ...
         table.on('tool(currentTableFilter)', function (obj) {
             ...
             if (obj.event === 'delete') {
                 layer.confirm('真的删除行么', function (index) {
                 	 $.ajax({
                          type: "post",
                          url: "StoreoutAction?method=delete",
                          dataType:'json',
                          data: "storeoutId="+data.storeoutId,
                          dataType: "json",
